            ...
            <tr class="hover:bg-[#fafafa] transition-colors group">
              ...
              <td class="px-4 py-4 relative">
                ...
                {#if activeMenu === org.id}
                  <div
                    class="absolute right-4 top-12 z-30 w-44 bg-white rounded-xl border border-[#e5e7eb]
                           shadow-lg shadow-black/5 py-1 overflow-hidden"
                  >
                    <button
                      onclick={() => handleAction('view', org)}
                      class="w-full flex items-center gap-2.5 px-4 py-2.5 text-sm text-[#374151]
                    ...
                    <button
                      onclick={() => handleAction('block', org)}
                      class="w-full flex items-center gap-2.5 px-4 py-2.5 text-sm text-[#dc2626]
                             hover:bg-[#fef2f2] transition-colors text-left"
                    >
        ...
        <div class="px-4 py-4">
          <div class="flex items-start justify-between gap-3">
            ...
            <div class="relative shrink-0">
              <button
                onclick={() => toggleMenu(org.id)}
                class="w-8 h-8 flex items-center justify-center rounded-lg text-[#9ca3af]
              ...
              {#if activeMenu === org.id}
                <div
                  class="absolute right-0 top-9 z-30 w-44 bg-white rounded-xl border border-[#e5e7eb]
                         shadow-lg shadow-black/5 py-1 overflow-hidden"
                >
                  <button
                    onclick={() => handleAction('view', org)}
      ...
      <div class="flex items-center gap-1">
          ...
          <button
            ...
            class="w-8 h-8 flex items-center justify-center rounded-lg text-sm font-medium transition-colors
                   {currentPage === page
                     ...
                     : 'text-[#374151] hover:bg-[#f9fafb] border border-[#e5e7eb]'}"
          >
            {page}
          </button>
        {/each}
        ...
        <button
          ...
          class="w-8 h-8 flex items-center justify-center rounded-lg
                 bg-[#1a2e3b] text-white hover:bg-[#243647]
